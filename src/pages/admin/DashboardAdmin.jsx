                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                                        ...
                                        {[...orders].reverse().slice(0, 5).map((order) => (
                                            <tr key={order._id} className="hover:bg-gray-50 transition-colors">
                                                ...
                                                <td className="px-6 py-4">
                                                    <span className={`px-3 py-1 rounded-full text-[10px] font-bold ${getStatusStyle(order.orderStatus)}`}>
                                                        {order.orderStatus}
                                                    </span>
                                                </td>
                    ...
                    <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                        ...
                        <div className="space-y-4">
                            {[
                                { name: 'Gül Aranjmanları', perc: 65, color: 'bg-rose-500' },
                                { name: 'Saksı Çiçekleri', perc: 45, color: 'bg-emerald-500' },
                                { name: 'Orkideler', perc: 30, color: 'bg-blue-500' },
                                { name: 'Vazo Çiçekleri', perc: 20, color: 'bg-amber-500' }
                            ].map((cat, i) => (
                                <div key={i}>
