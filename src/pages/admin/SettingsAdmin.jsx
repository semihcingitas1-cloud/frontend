...
import { getSiteSettings, updateStoreStatus, updateAvatar } from '../../redux/settingsSlider';
...
import { User, Lock, Bell, Globe, Camera, Save, ShieldCheck, Instagram, Phone, CheckCircle2, Clock, Store, CreditCard, Activity, AlertCircle, Hash, Image as ImageIcon, TwitterIcon, Linkedin, FolderPlus } from 'lucide-react';
import { PiPinterestLogoBold, PiSnapchatLogo, PiWhatsappLogo } from 'react-icons/pi';
import { ImReddit } from 'react-icons/im';
import { RiFacebookCircleLine } from "react-icons/ri";
import { FaBell, FaShoppingBasket, FaEnvelopeOpenText, FaUserPlus, FaPlus, FaTrash, FaFolderOpen, FaTruck, FaLiraSign } from 'react-icons/fa';
...
const SettingsAdmin = () => {
  ...
  const handleStoreToggle = () => {
    ...
    dispatch(updateStoreStatus(!isStoreOpen));
  };
            ...
            <div className="flex-1 bg-white rounded-[3.5rem] shadow-sm border border-gray-50 p-8 md:p-12 relative">
                ...
                <div className="flex flex-col sm:flex-row items-center gap-10">
                  ...
                  <div className="relative group">
                    ...
                    <div className="w-36 h-36 rounded-[2.5rem] bg-rose-50 border-[6px] border-white shadow-2xl overflow-hidden rotate-2 group-hover:rotate-0 transition-all duration-500">
                      ...
                      <img src={avatarPreview} alt="Admin" className="w-full h-full object-cover scale-110 group-hover:scale-100 transition-transform" />
              ...
              {activeTab === 'magaza' && ( <div className="animate-fadeIn space-y-10">
                ...
                <div className="flex items-center justify-between bg-gray-50 p-6 rounded-[2rem]">
                  ...
                  <button onClick={handleStoreToggle} className={`px-8 py-3 rounded-2xl font-black text-xs tracking-tighter transition-all shadow-sm ${isStoreOpen ? 'bg-green-500 text-white' : 'bg-red-500 text-white'}`}>{isStoreOpen ? 'MAĞAZA ŞU AN AÇIK' : 'MAĞAZA ŞU AN KAPALI'}</button>
              ...
              {activeTab === 'category' && ( <div className="animate-fadeIn space-y-8">
                    ...
                    <section>
                      ...
                      <form onSubmit={submitHandler} className='bg-white p-6 rounded-2xl shadow-sm border border-gray-100 mb-6'>
                        ...
                        <div className='flex gap-4'>
                          ...
                          <input type="text" value={name} onChange={(e) => setName(e.target.value)} placeholder="Örn: Buket, Cenaze..." className='flex-1 px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-rose-500 outline-none transition-all'/>
                        ...
                        <table className='w-full text-left'>
                          ...
                          <tbody className='divide-y divide-gray-50'>
                            ...
                            {shippings && shippings.map(ship => ( <tr key={ship._id} className='hover:bg-gray-50/50 transition-colors'>
                              ...
                              <td className='px-6 py-4 text-right'><button onClick={() => dispatch(deleteShipping(ship._id))} className='p-2 text-gray-300 hover:text-red-500 transition-colors'><FaTrash size={16} /></button></td>
